...
namespace Xahau.BinaryCodec.Types
{
    ...
    public class AccountId : Hash160
    {
        ...
        {
            get => _encoded ??= XahauCodec.EncodeAccountID(Buffer);
            set => _encoded = value;
        }
        /// <summary>
        ...
        public AccountId(string v) :
            this(XahauCodec.DecodeAccountID(v), v) {}
        /// <summary>
        /// Defines how to construct an AccountID
        /// </summary>
        /// <param name="hash">a hex-string</param>
        public AccountId(byte[] hash) :
            this(hash, XahauCodec.EncodeAccountID(hash)) {}
        ...
        public static AccountId FromValue(string value)
        {
            ...
            return new AccountId(XahauCodec.DecodeAccountID(value));
        }
