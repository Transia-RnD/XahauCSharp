...
namespace Xahau.Sugar
{
    ...
    public static class BalancesSugar
    {
        ...
        public static async Task<string> GetXrpBalance(this XahauClient client, string address, string? ledgerHash = null, LedgerIndex? lederIndex = null)
        {
        ...
        public static async Task<List<Balance>> GetBalances(this XahauClient client, string address, GetBalancesOptions options = null)
        {
