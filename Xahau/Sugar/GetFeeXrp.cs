...
namespace Xahau.Sugar
{
    public static class GetFeeXrpSugar
    {
        ...
        public static async Task<string> GetFeeXrp(this IXahauClient client, double? cushion = null)
        {
            ...
            if (baseFee == null)
            {
                throw new XahauException("getFeeXrp: Could not get base_fee_xrp from server_info");
            }
