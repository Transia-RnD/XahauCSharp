...
namespace Xahau.Sugar
{
    public static class SubmitSugar
    {
        ...
        public static async Task<Submit> Submit(this IXahauClient client,
            Dictionary<string, dynamic> transaction,
            bool autofill = false,
            bool failHard = false,
            XahauWallet wallet = null
        )
        {
        ...
        public static async Task<TransactionResponseCommon> SubmitAndWait(this IXahauClient client,
            Dictionary<string, dynamic> transaction,
            bool autofill = false,
            bool failHard = false,
            XahauWallet wallet = null)
        ...
        /// <param name="failHard">If true, and the transaction fails locally, do not retry or relay the transaction to other servers.</param>
        /// <returns></returns>
        public static async Task<Submit> SubmitRequest(this IXahauClient client, object signedTransaction, bool failHard)
        {
            ...
            string signedTxEncoded = signedTransaction is string transaction ? transaction : XahauBinaryCodec.Encode(signedTransaction);
        ...
        private static async Task<TransactionResponseCommon> WaitForFinalTransactionOutcome(this IXahauClient Client, string TxHash, uint? lastLedger, string submissionResult)
        {
        ...
        public static async Task<string> GetSignedTx(this IXahauClient client,
            Dictionary<string, dynamic> transaction,
            bool autofill = false,
            bool failHard = false,
            XahauWallet? wallet = null
        ...
        public static bool IsSigned(object transaction)
        {
            ...
            {
                var ob = XahauBinaryCodec.Encode(transaction);
