...
using static Xahau.Client.RequestManager;
...
namespace Xahau.Client
{
    public class Connection
    {
        ...
        public async Task Connect()
        {
            ...
            if (this.ws != null)
            {
                throw new XahauException("Websocket connection never cleaned up.");
            }
            ...
            if (this.ws == null)
            {
                throw new XahauException("Connect: created null websocket");
            }
        ...
        public async Task<Dictionary<string, dynamic>> Request(Dictionary<string, dynamic> request, int? timeout = null)
        {
            ...
            XahauRequest _request = this.requestManager.CreateRequest(request, timeout ?? this.config.timeout);
            try
            {
        ...
        public async Task<dynamic> GRequest<T, R>(R request, int? timeout = null)
        {
            ...
            XahauGRequest _request = this.requestManager.CreateGRequest<T, R>(request, timeout ?? this.config.timeout);
            try
            {
                WebsocketSendAsync(this.ws, _request.Message);
            }
        ...
        private async Task OnceOpen()
        {
            if (this.ws == null)
            {
                throw new XahauException("onceOpen: ws is null");
            }
        ...
        private async Task OnceClose(int? code)
        {
            //if (this.ws == null)
            //{
            //    throw new XahauException("OnceClose: ws is null");
            //}
