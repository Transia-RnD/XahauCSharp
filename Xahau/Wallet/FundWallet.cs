...
namespace Xahau.Wallet
{
    ...
    public class WalletSugar
    {
        ...
        public class Funded
        {
            ...
            public Funded(XahauWallet wallet, double balance)
            {
                Wallet = wallet;
                Balance = balance;
            }
        ...
        public static async Task<Funded> FundWallet(IXahauClient client, XahauWallet? wallet = null, string? faucetHost = null)
        {
            ...
            XahauWallet walletToFund = (wallet != null && XahauCodec.IsValidClassicAddress(wallet.ClassicAddress)) ? wallet : XahauWallet.Generate();
        ...
        private static IXahauClient _client;
        ...
        public static string GetFaucetHost(IXahauClient client)
        {
