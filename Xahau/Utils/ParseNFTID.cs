...
namespace Xahau.Utils
{
    public static class ParseNFTID
    {
        ...
        public static NFTokenIDData ParseNFTokenID(this string nftokenID)
        {
            ...
            {
                throw new XahauException($"Attempting to parse a nftokenID with length ${nftokenID.Length}\n" +
            ...
            string issuer = XahauCodec.EncodeAccountID(nftokenID.Substring(8, 40).FromHexToBytes());
        ...
        public static string ParseNFTOffer(string account, uint sequence)
        {
            ...
            byte[] accountBytes = XahauCodec.DecodeAccountID(account);
