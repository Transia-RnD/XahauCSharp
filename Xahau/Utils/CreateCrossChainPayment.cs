...
namespace Xahau.Utils
{
    public static class CrossChainPayment
    {
        ...
        /// <exception cref="XahauException">if there are more than 2 memos.</exception>
        public static Payment CreateCrossChainPayment(this Payment payment, string destAccount) //todo check it
        {
            ...
            if (memos.Count > 2)
            {
                throw new XahauException("Cannot have more than 2 memos in a cross-chain transaction.");
            }
