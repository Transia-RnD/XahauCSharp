...
namespace Xahau.Keypairs.Tests
{
    ...
    public class TestUCodec
    {
        ...
        {
            string actual = XahauCodec.EncodeAccountID("BA8E78626EE42C41B46D46C3048DF3A1C3C87072".FromHex());
        ...
        {
            string actual = XahauCodec.EncodeNodePublic("0388E5BA87A000CB807240DF8C848EB0B5FFA5C8E5A521BC8E105C0F0A44217828".FromHex());
        ...
        {
            DecodedSeed decoded = XahauCodec.DecodeSeed("sEdTM1uX8pu2do5XvTnutH6HsouMaM2");
            Assert.AreEqual(decoded.Bytes.ToHex(), "4C3A1D213FBDFB14C7C28D609469B341");
            Assert.AreEqual(decoded.Type, "ed25519");

            DecodedSeed decoded2 = XahauCodec.DecodeSeed("sn259rEFXrQrWyx3Q7XneWcwV6dfL");
        ...
        public void TestEncodeSeedWithType()
        {
            ...
            Assert.AreEqual(decoded.Bytes.ToHex(), "4C3A1D213FBDFB14C7C28D609469B341");
            Assert.AreEqual(decoded.Type, "ed25519");
            Assert.AreEqual(XahauCodec.EncodeSeed(decoded.Bytes, decoded.Type), edSeed);
        }
    }
}