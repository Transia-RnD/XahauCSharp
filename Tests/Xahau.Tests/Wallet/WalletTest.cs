...
namespace Xahau.Tests.Wallet.Tests.Constructor
{
    [TestClass]
    public class TestUConstructor
    {
        ...
        public void Test()
        {
            ...
            XahauWallet wallet = new XahauWallet(
...
namespace Xahau.Tests.Wallet.Tests.Generate
{
    [TestClass]
    public class TestUGenerate
    {
        ...
        {
            XahauWallet wallet = XahauWallet.Generate("secp256k1");
        ...
        {
            XahauWallet wallet = XahauWallet.Generate("ed25519");
...
namespace Xahau.Tests.Wallet.Tests.Seed
{
    [TestClass]
    public class TestUSeed
    {
        ...
        {
            XahauWallet wallet = XahauWallet.FromSeed(seed, null, "secp256k1");
        ...
        {
            XahauWallet wallet = XahauWallet.FromSeed(seed, null, "ed25519");
        ...
        public void TestRegularKeypairSeed()
        {
            ...
            XahauWallet wallet = XahauWallet.FromSeed(seed, masterAddress, "secp256k1");
...
namespace Xahau.Tests.Wallet.Tests.Entropy
{
    [TestClass]
    public class TestUEntropy
    {
        ...
        {
            XahauWallet wallet = XahauWallet.FromEntropy(entropy);
        ...
        {
            XahauWallet wallet = XahauWallet.FromEntropy(entropy, "secp256k1");
        ...
        {
            XahauWallet wallet = XahauWallet.FromEntropy(entropy, "ed25519");
        ...
        {
            string masterAddress = "rUAi7pipxGpYfPNg3LtPcf2ApiS8aw9A93";
            XahauWallet wallet = XahauWallet.FromEntropy(entropy, masterAddress);
...
namespace Xahau.Tests.Wallet.Tests.Sign
{
    [TestClass]
    public class TestUSign
    {
        ...
        {
            var wallet = XahauWallet.FromSeed("ss1x3KLrSvfg7irFc1D929WXZ7z9H");
        ...
        public void TestSignPaymentNoFlags()
        {
            ...
            JToken decoded = XahauBinaryCodec.Decode(result.TxBlob);
...
namespace Xahau.Tests.Wallet.Tests.Verify
{
    [TestClass]
    public class TestUVerify
    {
        ...
        public void TestVerifySameWallet()
        {
            ...
            var wallet = new XahauWallet(publicKey, privateKey);
        ...
        public void TestVerifyDifferentWallet()
        {
            ...
            var wallet = new XahauWallet(diffPublicKey, diffPrivateKey);
            bool isVerified = wallet.VerifyTransaction(prepared["signedTransaction"]);
            Assert.IsFalse(isVerified);
        }
    }
}
namespace Xahau.Tests.Wallet.Tests.XAddress
{
    [TestClass]
    public class TestUXAddress
    {
        ...
        private XahauWallet wallet = new XahauWallet(publicKey, privateKey);
...
namespace Xahau.Tests.Wallet.Tests.XummNumbers
{
    [TestClass]
    public class TestUXummNumbers
    {
        ...
        {
            XahauWallet result = XahauWallet.FromXummNumbers(xummNumbers, "secp256k1");
        ...
        public void TestVerify_InValid_EntropyFromXummNumbers()
        {
            ...
            numbers[0] = "556862";
            Assert.ThrowsException<ArgumentException>(() => XahauWallet.FromXummNumbers(numbers), "Wrong numbers");
        }
