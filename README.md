[![NuGet Badge](https://buildstats.info/nuget/XahauCSharp)](https://www.nuget.org/packages/XahauCSharp/)
...
<!-- [![Supported Versions](https://img.shields.io/pypi/pyversions/XahauCSharp.svg)](https://pypi.org/project/xrpl-py) -->
...
The `XahauCSharp` library automatically populates the `fee`, `sequence` and `last_ledger_sequence` fields when you create transactions. In the example above, you could omit those fields and let the library fill them in for you.
